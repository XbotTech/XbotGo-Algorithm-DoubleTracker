...
void BYTETracker::joint_stracks(std::vector<STrack*> & res, std::vector<STrack*> &tlista, std::vector<STrack> &tlistb)
{
...
void BYTETracker::sub_stracks(std::vector<STrack> & res, std::vector<STrack> &tlista, std::vector<STrack> &tlistb)
{
...
void BYTETracker::remove_duplicate_stracks(std::vector<STrack> &resa, std::vector<STrack> &resb, std::vector<STrack> &stracksa, std::vector<STrack> &stracksb)
{
	...
	iou_distance(pdist, stracksa, stracksb);
...
void BYTETracker::ious(std::vector<std::vector<float> > & ious, std::vector<std::vector<float> * > &atlbrs, std::vector<std::vector<float> * > &btlbrs)
{
	ious.clear();
...
void BYTETracker::iou_distance(std::vector<std::vector<float> >& cost_matrix, std::vector<STrack*> &atracks, std::vector<STrack> &btracks, int &dist_size, int &dist_size_size)
{
	cost_matrix.clear();
...
void BYTETracker::iou_distance(std::vector<std::vector<float> > & cost_matrix, std::vector<STrack> &atracks, std::vector<STrack> &btracks)
{
	std::vector<std::vector<float>* > atlbrs, btlbrs;
	for (int i = 0; i < atracks.size(); i++)
	{
